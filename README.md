...
2.	The usage retrieval uses a bash script to retrieve the usage json file from Aussie Broadband. This then requires the Linux package mosquito-clients installed to publish the JSON data to an Mosquitto broker.
